...
var routes = [
    {
        path: '',
        loadChildren: function () { return Promise.all(/*! import() | pages-inicio-inicio-module */[__webpack_require__.e("default~pages-inicio-inicio-module~pages-principal-principal-module"), __webpack_require__.e("default~pages-inicio-inicio-module~pages-olvide-password-olvide-password-module"), __webpack_require__.e("pages-inicio-inicio-module")]).then(__webpack_require__.bind(null, /*! ./pages/inicio/inicio.module */ "./src/app/pages/inicio/inicio.module.ts")).then(function (m) { return m.InicioPageModule; }); }
    },
    {
        path: 'principal',
        loadChildren: function () { return Promise.all(/*! import() | pages-principal-principal-module */[__webpack_require__.e("default~pages-inicio-inicio-module~pages-principal-principal-module"), __webpack_require__.e("pages-principal-principal-module")]).then(__webpack_require__.bind(null, /*! ./pages/principal/principal.module */ "./src/app/pages/principal/principal.module.ts")).then(function (m) { return m.PrincipalPageModule; }); },
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'sendnewpassword',
        loadChildren: function () { return Promise.all(/*! import() | pages-olvide-password-olvide-password-module */[__webpack_require__.e("default~pages-inicio-inicio-module~pages-olvide-password-olvide-password-module"), __webpack_require__.e("pages-olvide-password-olvide-password-module")]).then(__webpack_require__.bind(null, /*! ./pages/olvide-password/olvide-password.module */ "./src/app/pages/olvide-password/olvide-password.module.ts")).then(function (m) { return m.OlvidePasswordPageModule; }); }
    }
];
...
/* harmony import */ var _services_authmovil_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./services/authmovil.service */ "./src/app/services/authmovil.service.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _services_authmovil_service__WEBPACK_IMPORTED_MODULE_18__["AuthMovilService"]
            ],
...
/* harmony import */ var _services_authmovil_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/authmovil.service */ "./src/app/services/authmovil.service.ts");
...
var AuthGuard = /** @class */ (function () {
    function AuthGuard(authService, router, authMovilService, plataform) {
        this.authService = authService;
        this.router = router;
        this.authMovilService = authMovilService;
    ...
    AuthGuard.ctorParameters = function () { return [
        ...
        { type: _services_authmovil_service__WEBPACK_IMPORTED_MODULE_4__["AuthMovilService"] },
    ...
    AuthGuard = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"],
            ...
            _services_authmovil_service__WEBPACK_IMPORTED_MODULE_4__["AuthMovilService"],
...
/*!******************************************!*\
  !*** ./src/app/services/auth.service.ts ***!
  \******************************************/
/*! exports provided: TOKEN_NAME, HTTP_OPTIONS, AuthService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var TOKEN_NAME = 'token_user';
var HTTP_OPTIONS = { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
...
var AuthService = /** @class */ (function () {
    ...
    Object.defineProperty(AuthService.prototype, "authenticated", {
        get: function () { return this._autenticated; },
        set: function (autenticated) {
    ...
    AuthService.prototype.login = function (username, password) {
        var _this = this;
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].api + 'login', { 'username': username, 'password': password }, this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (data) {
            localStorage.setItem(TOKEN_NAME, data.token);
            _this.currentUserSubject.next(data.username); // <-- pump the value in here
            return data;
        }));
    };
    ...
    AuthService.prototype.setpassword = function (email) {
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].api + 'api/usuario/sendPassword', { email: email }, this.httpOptions);
    };
...
/***/ "./src/app/services/authmovil.service.ts":
/*!***********************************************!*\
  !*** ./src/app/services/authmovil.service.ts ***!
  \***********************************************/
/*! exports provided: TOKEN_NAME, AuthMovilService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TOKEN_NAME", function() { return TOKEN_NAME; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AuthMovilService", function() { return AuthMovilService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var AuthMovilService = /** @class */ (function () {
    function AuthMovilService(http) {
        this.http = http;
        this._autenticated = false;
        this.currentUserSubject = new rxjs__WEBPACK_IMPORTED_MODULE_4__["BehaviorSubject"](null);
    }
    Object.defineProperty(AuthMovilService.prototype, "authenticated", {
        get: function () { return this._autenticated; },
        set: function (autenticated) {
            this._autenticated = autenticated;
        },
    ...
    ;
    AuthMovilService.prototype.login = function (username, password) {
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api + 'login', { 'username': username, 'password': password }, { 'Content-Type': 'application/json' });
    };
    AuthMovilService.prototype.getToken = function () {
        return localStorage.getItem(TOKEN_NAME);
    };
    AuthMovilService.prototype.setToken = function (token) {
        localStorage.setItem(TOKEN_NAME, token);
    };
    AuthMovilService.prototype.getTokenExpirationDate = function (token) {
        var decoded = jwt_decode__WEBPACK_IMPORTED_MODULE_5__(token);
        if (decoded.exp === undefined)
            return null;
        var date = new Date(0);
    ...
    AuthMovilService.prototype.isTokenExpired = function (token) {
        if (!token)
            token = this.getToken();
        if (!token)
            return true;
    ...
    AuthMovilService.ctorParameters = function () { return [
        { type: _ionic_native_http_ngx__WEBPACK_IMPORTED_MODULE_2__["HTTP"] }
    ]; };
    AuthMovilService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_native_http_ngx__WEBPACK_IMPORTED_MODULE_2__["HTTP"]])
    ], AuthMovilService);
    return AuthMovilService;
}());
...
module.exports = __webpack_require__(/*! C:\Users\Gustavo Huerta\Documents\proyects\pmrapp\Fronted\src\main.ts */"./src/main.ts");
