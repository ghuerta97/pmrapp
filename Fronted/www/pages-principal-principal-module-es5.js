...
var routes = [
    {
        ...
        children: [
            {
                path: 'buscador',
                loadChildren: function () { return Promise.all(/*! import() | horas-buscador-horas-buscador-module */[__webpack_require__.e("common"), __webpack_require__.e("horas-buscador-horas-buscador-module")]).then(__webpack_require__.bind(null, /*! ../horas-buscador/horas-buscador.module */ "./src/app/pages/horas-buscador/horas-buscador.module.ts")).then(function (m) { return m.HorasBuscadorPageModule; }); }
            },
            {
                path: 'horas-solicitadas',
                loadChildren: function () { return Promise.all(/*! import() | horas-solicitadas-horas-solicitadas-module */[__webpack_require__.e("common"), __webpack_require__.e("horas-solicitadas-horas-solicitadas-module")]).then(__webpack_require__.bind(null, /*! ../horas-solicitadas/horas-solicitadas.module */ "./src/app/pages/horas-solicitadas/horas-solicitadas.module.ts")).then(function (m) { return m.HorasSolicitadasPageModule; }); }
            }
        ]
    }
];
...
var PrincipalPage = /** @class */ (function () {
    function PrincipalPage(authService, pacienteService) {
    ...
    PrincipalPage.prototype.ngOnInit = function () {
        ...
        this.authService.getCurrentUser()
            ...
            _this.pacienteService.getPacienteWithRun(data)
                .subscribe(function (data) {
                _this.paciente = data;
            }, function (error) {
                console.error(error);
    ...
    PrincipalPage.prototype.ngAfterViewInit = function () {
    };
    PrincipalPage.prototype.ngOnChanges = function (changes) {
    };
...
var PacienteService = /** @class */ (function () {
    ...
    PacienteService.prototype.getPacienteWithRun = function (rut) {
