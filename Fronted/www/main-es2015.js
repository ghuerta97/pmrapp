...
const routes = [
    {
        path: '',
        loadChildren: () => Promise.all(/*! import() | pages-inicio-inicio-module */[__webpack_require__.e("default~pages-inicio-inicio-module~pages-principal-principal-module"), __webpack_require__.e("default~pages-inicio-inicio-module~pages-olvide-password-olvide-password-module"), __webpack_require__.e("pages-inicio-inicio-module")]).then(__webpack_require__.bind(null, /*! ./pages/inicio/inicio.module */ "./src/app/pages/inicio/inicio.module.ts")).then(m => m.InicioPageModule)
    },
    {
        path: 'principal',
        loadChildren: () => Promise.all(/*! import() | pages-principal-principal-module */[__webpack_require__.e("default~pages-inicio-inicio-module~pages-principal-principal-module"), __webpack_require__.e("pages-principal-principal-module")]).then(__webpack_require__.bind(null, /*! ./pages/principal/principal.module */ "./src/app/pages/principal/principal.module.ts")).then(m => m.PrincipalPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'sendnewpassword',
        loadChildren: () => Promise.all(/*! import() | pages-olvide-password-olvide-password-module */[__webpack_require__.e("default~pages-inicio-inicio-module~pages-olvide-password-olvide-password-module"), __webpack_require__.e("pages-olvide-password-olvide-password-module")]).then(__webpack_require__.bind(null, /*! ./pages/olvide-password/olvide-password.module */ "./src/app/pages/olvide-password/olvide-password.module.ts")).then(m => m.OlvidePasswordPageModule)
    }
];
...
let AuthGuard = class AuthGuard {
    constructor(authService, router, authMovilService, plataform) {
...
const HTTP_OPTIONS = { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
...
let AuthService = class AuthService {
    ...
    get authenticated() { return this._autenticated; }
    ;
    set authenticated(autenticated) {
    ...
    getTokenExpirationDate(token) {
        const decoded = jwt_decode__WEBPACK_IMPORTED_MODULE_5__(token);
...
let AuthMovilService = class AuthMovilService {
    constructor(http) {
        this.http = http;
        this._autenticated = false;
        this.currentUserSubject = new rxjs__WEBPACK_IMPORTED_MODULE_4__["BehaviorSubject"](null);
...
AuthMovilService.ctorParameters = () => [
