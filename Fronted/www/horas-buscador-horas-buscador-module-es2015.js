...
let BuscadorComponent = class BuscadorComponent {
    constructor(horaService, loadingController) {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (search.length > 0) {
                for (let i = 0; i < search.length; i++) {
                    this.horaService.getHorasEspecilistas(search[i].value.nombre).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["finalize"])(() => loading.dismiss()))
                        .subscribe(result => {
                        if (result) {
...
let DialogConfirmationComponent = class DialogConfirmationComponent {
    constructor(dialogRef, data, horaService) {
...
let HorasBuscadorPageRoutingModule = class HorasBuscadorPageRoutingModule {
};
...
let HorasBuscadorPageModule = class HorasBuscadorPageModule {
};
...
let HorasBuscadorPage = class HorasBuscadorPage {
    constructor(storage, pacienteService, horaService, dialog) {
    ...
    ngOnInit() {
        ...
        this.horaService.getHorasEspecilistas('medico general')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["finalize"])(() => { this.buscando = false; }))
            .subscribe(data => {
    ...
    asignarHora(element) {
        const dialogElem = this.dialog.open(_DialogConfirmation_dialog_confirmation_component__WEBPACK_IMPORTED_MODULE_6__["DialogConfirmationComponent"], {
            data: {
                hora: element
            }
        });
...
HorasBuscadorPage.ctorParameters = () => [
...
//# sourceMappingURL=horas-buscador-horas-buscador-module-es2015.js.map